    ...
    <section className="editorial-hero" id="hero">
      <div className="hero-grid-container">
        ...
        <div className="hero-main-column">
          <div className="hero-meta-tag hero-ticker-bar">
            <span className="meta-accent-dot pulsing"></span>
            <span>AVAILABLE FOR INTERNSHIPS &amp; AI COLLABORATIONS</span>
          </div>
          ...
          <div className="hero-cta-group">
            ...
            <button onClick={handleCopyEmail} className="cta-btn cta-btn-secondary">
        ...
        {/* Right Side: Interactive Developer Workspace Card */}
        <div className="hero-workstation-card">
          ...
          <div className="workstation-body">
            ...
            <div className="workstation-block">
              ...
              <div className="highlights-rows">
                <div className="highlight-item">
                  ...
                  <span className="hl-badge live">2nd Round Qualifier</span>
                </div>
                <div className="highlight-item">
                  <span className="hl-key">Women Who Aspire</span>
                  <span className="hl-badge hack">Round 1 Attempted</span>
                </div>
                <div className="highlight-item">
            ...
            <div className="workstation-status-line">
              <span className="status-prompt">$ status --ready_for_collaboration</span>
